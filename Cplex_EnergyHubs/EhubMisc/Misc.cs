...
namespace EhubMisc
{
    ...
    public static class Clustering
    {
        ...
        /// <returns></returns>
        public static Tuple<double [,], int [][]> KMeans(double [,] dataset, int Clusters)
        {
            int n = dataset.GetLength(1); // problem dimension
            int m = dataset.GetLength(0); // number of dataset
            int K = Clusters;
