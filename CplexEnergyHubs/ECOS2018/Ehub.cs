...
namespace Cplex_ECOS2018
{
    ...
    internal class Ehub
    {
        ...
        {
            this.outputs = new EhubOutputs[epsilonsteps];
            ...
            double mincarb;
            double maxcarb;
            EhubOutputs outputtemp = new EhubOutputs();
        ...
        private EhubOutputs ehubmodel_elec(bool bln_mincarbon, double? carbonconstraint = null)
        {
            // Solver
            Cplex cpl = new Cplex();


            EhubOutputs outs = new EhubOutputs();
        ...
        private EhubOutputs ehubmodel_elecbat(bool bln_mincarbon, double? carbonconstraint = null)
        {
        ...
        private EhubOutputs ehubmodel_multi(bool bln_mincarbon, double? carbonconstraint = null)
        {
